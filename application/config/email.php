...
// $config['smtp_host']           = 'mail.kuangli.tw';
// $config['smtp_user']           = 'nshstu@kuangli.tw';
// $config['smtp_pass']           = 'kl61757273';
// $config['smtp_port']           = 587;
$config['smtp_host']           = 'mail.nshstu.org.tw';
$config['smtp_user']           = 'service@nshstu.org.tw';
$config['smtp_pass']           = 'Nshstu@admin';
$config['smtp_port']           = 587;
