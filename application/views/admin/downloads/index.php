<div class="row">
  <div class="col-md-6">
    <a href="/admin/downloads/create" class="btn btn-primary hidden-print">新增檔案下載</a>
    <a href="/admin/downloads/category" class="btn btn-success">分類</a>
  </div>
  <div class="col-md-6">
    <div class="form-inline text-right">
      ...
      <select id="category" class="form-control" onchange="searchFilter()">
        ...
        <?php foreach ($category as $data) {
          echo '<option value='.$data['download_category_id'].'>'.$data['download_category_name'].'</option>';
        } ?>
      </select>
