<div class="row">
    ...
    <?php echo form_open('admin/downloads/update/' . $downloads['download_id'], $attributes); ?>
    <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        echo form_dropdown('download_category', $data, $downloads['download_category'], $att);
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="download_name" name="download_name" value="<?php echo $downloads['download_name'] ?>" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>檔案</label><br>
                        <?php if(!empty($downloads['download_link'])) { ?>
                          <img src="/assets/uploads/<?php echo $downloads['download_link']; ?>" id="download_link_preview" class="img-responsive hide" style="<?php if (empty($downloads['download_link'])) {echo 'display: none';}?>">
                        <?php } else { ?>
                          <img src="" id="download_link_preview" class="img-responsive hide">
                        <?php } ?>
                        <input type="text" class="form-control" id="download_link" name="download_link" value="<?php echo $downloads['download_link']; ?>" readonly>
