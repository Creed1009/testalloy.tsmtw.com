    ...
    <tr>
      ...
      <td>
        ...
        <?php if($data['post_status'] == '1'){ ?>
          <a href="/admin/posts/go_off_the_shelf/<?php echo $data['post_id'] ?>" class="btn btn-primary btn-sm" onClick="return confirm('您確定要下架嗎?')">上架中</a>
        <?php } else { ?>
          <a href="/admin/posts/on_the_shelf/<?php echo $data['post_id'] ?>" class="btn btn-danger btn-sm" onClick="return confirm('您確定要上架嗎?')">已下架</a>
        <?php } ?>
