      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control datetimepicker" id="post_on_the_shelf" name="post_on_the_shelf" required="">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="post_off_the_shelf">下架日期</label>
            <input type="text" class="form-control datetimepicker" id="post_off_the_shelf" name="post_off_the_shelf">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea class="form-control tinymce" name="post_content" id="post_content" cols="30" rows="8"></textarea>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-6">
          <div style="border: 1px solid #888; padding: 15px;">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_link1" name="post_link1">
            </div>
            <div class="form-group">
              <label for="post_link_name1">連結名稱1</label>
              <input type="text" class="form-control" id="post_link_name1" name="post_link_name1">
            </div>
          </div>
          <div style="border: 1px solid #888; padding: 15px;">
            <div class="form-group">
              <label for="post_link2">連結2</label>
              <input type="text" class="form-control" id="post_link2" name="post_link2">
            </div>
            <div class="form-group">
              <label for="post_link_name2">連結名稱2</label>
              <input type="text" class="form-control" id="post_link_name2" name="post_link_name2">
            </div>
          </div>
          <div style="border: 1px solid #888; padding: 15px;">
            <div class="form-group">
              <label for="post_link3">連結3</label>
              <input type="text" class="form-control" id="post_link3" name="post_link3">
            </div>
            <div class="form-group">
              <label for="post_link_name3">連結名稱3</label>
              <input type="text" class="form-control" id="post_link_name3" name="post_link_name3">
            </div>
          </div>
          <div style="border: 1px solid #888; padding: 15px;">
            <div class="form-group">
              <label for="post_link4">連結4</label>
              <input type="text" class="form-control" id="post_link4" name="post_link4">
            </div>
            <div class="form-group">
              <label for="post_link_name4">連結名稱4</label>
              <input type="text" class="form-control" id="post_link_name4" name="post_link_name4">
            </div>
          </div>
          <div style="border: 1px solid #888; padding: 15px;">
            <div class="form-group">
              <label for="post_link5">連結5</label>
              <input type="text" class="form-control" id="post_link5" name="post_link5">
            </div>
            <div class="form-group">
              <label for="post_link_name5">連結名稱5</label>
              <input type="text" class="form-control" id="post_link_name5" name="post_link_name5">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div style="border: 1px solid gray; padding: 15px;">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file1" name="post_file1" readonly="">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file_name1" name="post_file_name1">
            </div>
          </div>
          <div style="border: 1px solid gray; padding: 15px;">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file2" name="post_file2" readonly="">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file_name2" name="post_file_name2">
            </div>
          </div>
          <div style="border: 1px solid gray; padding: 15px;">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file3" name="post_file3" readonly="">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file_name3" name="post_file_name3">
            </div>
          </div>
          <div style="border: 1px solid gray; padding: 15px;">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file4" name="post_file4" readonly="">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file_name4" name="post_file_name4">
            </div>
          </div>
          <div style="border: 1px solid gray; padding: 15px;">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file5" name="post_file5" readonly="">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_file_name5" name="post_file_name5">
            </div>
          </div>
        </div>
      </div>
