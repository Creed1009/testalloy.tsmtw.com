...
<?php echo form_open('admin/subscription/insert' , $attributes); ?>
  <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="subscription_code" name="subscription_code" required>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="subscription_address" name="subscription_address">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="subscription_phone">電話</label>
            <input type="text" class="form-control" id="subscription_phone" name="subscription_phone">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="subscription_site">網站</label>
            <input type="text" class="form-control" id="subscription_site" name="subscription_site">
          </div>
        </div>
      </div>
