<div class="row">
	...
	<div class="col-md-6">
		<div class="content-box-large">
			...
			<?php echo form_open('admin/links/update_category/' . $category['link_category_id'], $attributes); ?>
			  	<div class="form-group">
			    	<label for="link_category_name">分類名稱</label>
			    	<input type="text" class="form-control" name="link_category_name" value="<?php echo $category['link_category_name']; ?>">
			  	</div>
			    <div class="form-group">
