...
<?php echo form_open('admin/links/insert' , $attributes); ?>
  <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <?php $att = 'id="link_category" class="form-control chosen" data-rule-required="true"';
            $data = array();
            foreach ($category as $c)
            {
            $data[$c['link_category_id']] = $c['link_category_name'];
            }
            echo form_dropdown('link_category', $data, '0', $att);
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <img src="" id="link_image_preview" class="img-responsive" style="display: none;">
