<div class="row">
  <div class="col-md-6">
    <a href="/admin/links/create" class="btn btn-primary hidden-print">新增相關連結</a>
    <a href="/admin/links/category" class="btn btn-success">分類</a>
  </div>
  <div class="col-md-6">
    <div class="form-inline text-right">
      ...
      <select id="category" class="form-control" onchange="searchFilter()">
        ...
        <?php foreach ($category as $data) {
          echo '<option value='.$data['link_category_id'].'>'.$data['link_category_name'].'</option>';
        } ?>
      </select>
