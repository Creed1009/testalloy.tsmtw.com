...
<?php echo form_open('admin/products/insert' , $attributes); ?>
  <div class="col-md-12">
    ...
    <div class="content-box-large">
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            echo form_dropdown('product_manufacturer', $data, '0', $att); ?>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="product_activity_price" name="product_activity_price">
          </div>
        </div>
        ...
        <!-- <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="product_option1" name="product_option1">
          </div>
        </div> -->
        <input type="hidden" class="form-control" id="product_option1" name="product_option1">

        <!-- <div class="col-md-3">
          <div class="form-group">
            <label for="product_option2">其他選項</label>
            <input type="text" class="form-control" id="product_option2" name="product_option2">
          </div>
        </div> -->
        <input type="hidden" class="form-control" id="product_option2" name="product_option2">
        ...
        <div class="col-md-3">
          ...
          <div class="form-group" style="height: 400px; overflow-y: auto; background: white; padding: 10px; border: 1px solid #ccc;">
            <?php get_product_category_checkbox() ?>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control datetimepicker" id="product_on_the_shelf" name="product_on_the_shelf" required="">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="product_off_the_shelf">＊下架日期</label>
            <input type="text" class="form-control datetimepicker" id="product_off_the_shelf" name="product_off_the_shelf" required="">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group" style="border: 1px solid gray; padding: 5px;">
            <label>照片1</label><br>
            <img src="" id="product_image1_preview" class="img-responsive" style="width: 100px;">
            <input type="hidden" id="product_image1" name="product_image1">
        ...
        <div class="col-md-4">
          <div class="form-group" style="border: 1px solid gray; padding: 5px;">
            <label>照片2</label><br>
            <img src="" id="product_image2_preview" class="img-responsive" style="width: 100px;">
            <input type="hidden" id="product_image2" name="product_image2">
        ...
        <div class="col-md-4">
          <div class="form-group" style="border: 1px solid gray; padding: 5px;">
            <label>照片3</label><br>
            <img src="" id="product_image3_preview" class="img-responsive" style="width: 100px;">
            <input type="hidden" id="product_image3" name="product_image3">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group" style="border: 1px solid gray; padding: 5px;">
            <label>照片4</label><br>
            <img src="" id="product_image4_preview" class="img-responsive" style="width: 100px;">
            <input type="hidden" id="product_image4" name="product_image4">
        ...
        <div class="col-md-4">
          <div class="form-group" style="border: 1px solid gray; padding: 5px;">
            <label>照片5</label><br>
            <img src="" id="product_image5_preview" class="img-responsive" style="width: 100px;">
            <input type="hidden" id="product_image5" name="product_image5">
        ...
        <div class="col-md-4">
          <div class="form-group" style="border: 1px solid gray; padding: 5px;">
            <label>照片6</label><br>
            <img src="" id="product_image6_preview" class="img-responsive" style="width: 100px;">
            <input type="hidden" id="product_image6" name="product_image6">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea class="form-control tinymce" name="product_description" id="product_description" cols="30" rows="3"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea class="form-control tinymce" name="product_content" id="product_content" cols="30" rows="10"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea class="form-control tinymce" name="product_remark" id="product_remark" cols="30" rows="10"></textarea>
          </div>
        </div>
      </div>
