<div class="row">
  <div class="col-md-6">
    <a href="/admin/messages/create" class="btn btn-primary hidden-print">新增訊息</a>
    <!-- <a href="/admin/messages/category" class="btn btn-success">分類</a> -->
  </div>
  <div class="col-md-6">
    <div class="form-inline text-right">
      ...
      <!-- <select id="category" class="form-control" onchange="searchFilter()">
        ...
        <?php foreach ($category as $data) {
          echo '<option value='.$data['message_category_id'].'>'.$data['message_category_name'].'</option>';
        } ?>
      </select> -->
