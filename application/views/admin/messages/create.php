...
<?php echo form_open('admin/messages/insert' , $attributes); ?>
  <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control datepicker" id="message_date" name="message_date" autocomplete="off" required>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            ...
            echo form_dropdown('message_category', $data, '', $att); ?>
          </div>
        </div>

        <?php if($this->ion_auth->is_admin()){ ?>
        <div class="col-md-3" id="school_area" style="display: none;">
          <div class="form-group">
        ...
        <div class="col-md-3" id="users_area" style="display: none;">
          <div class="form-group">
            ...
            echo form_dropdown('message_to', $data, '0', $att);
        ...
        <?php } else { ?>
          <div class="col-md-3" id="school_area">
            <div class="form-group">
              <label for="message_school">服務學校 *</label>
          ...
          <div class="col-md-3" id="users_area" style="display: none;">
            <div class="form-group">
              ...
              <!-- <span class="text-danger">如發送的對象是學校全體，請不要選擇對象</span> -->
              <!-- <input type="hidden" name="message_to" value="0"> -->
            </div>
          </div>
        <?php } ?>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="message_title" name="message_title" required>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea class="form-control tinymce" name="message_content" id="message_content" cols="30" rows="20"></textarea>
          </div>
        </div>
      </div>
    </div>
